...
const plans = [
  {
    ...
    features: ["5 images per month", "Standard quality", "PNG download", "Community support"],
    cta: "Get Started",
    popular: false,
  },
  {
    ...
    features: ["10 images per month", "HD quality output", "Priority processing", "Batch upload", "Email support"],
    cta: "Go Pro",
    popular: true,
  },
  {
    ...
    features: ["50 image credits", "HD quality output", "Never expires", "Priority support"],
    cta: "Buy Credits",
    popular: false,
  },
];
